...
CIMGUI_API void         cimgui::ImGui_PushFontFloat(cimgui::ImFont* font, float font_size_base_unscaled)
{
...
CIMGUI_API cimgui::ImDrawList* cimgui::ImGui_GetBackgroundDrawListEx(cimgui::ImGuiViewport* viewport)
{
...
CIMGUI_API cimgui::ImDrawList* cimgui::ImGui_GetForegroundDrawListEx(cimgui::ImGuiViewport* viewport)
{
...
CIMGUI_API void cimgui::ImGui_DebugLogUnformatted(const char* text)
{
    ::ImGui::DebugLog("%s", text);
}
...
CIMGUI_API void   cimgui::ImGui_ImageImVec4(cimgui::ImTextureRef tex_ref, cimgui::ImVec2 image_size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1, cimgui::ImVec4 tint_col, cimgui::ImVec4 border_col)
{
