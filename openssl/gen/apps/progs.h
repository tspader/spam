...
extern int configutl_main(int argc, char *argv[]);
...
extern int ech_main(int argc, char *argv[]);
...
extern const OPTIONS configutl_options[];
...
extern const OPTIONS ech_options[];
